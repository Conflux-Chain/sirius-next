...
export const IS_CSPACE =
  IS_CSPACE_MAINNET || IS_CSPACE_TESTNET || IS_CSPACE_DEVNET;
  
export const IS_MAINNET = IS_ESPACE_MAINNET || IS_BSPACE_MAINNET || IS_CSPACE_MAINNET;
export const IS_TESTNET = IS_ESPACE_TESTNET || IS_BSPACE_TESTNET || IS_CSPACE_TESTNET;
export const IS_DEVNET = IS_ESPACE_DEVNET || IS_BSPACE_DEVNET || IS_CSPACE_DEVNET;
