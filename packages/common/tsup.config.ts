...
// const getFilesEntry = (filePath: string, allComponents: Record<string, string>) => {
//   readdirSync(filePath).forEach(
//     (component) => {
//       if (component === 'types') {
//         return;
//       }
...
//         } else {
//           allComponents[`${filePath}/${component}`.replace('./src/', '').replace(/\.tsx?/, '')] = `${filePath}/${component}`;
//         }
//       } catch (_) {
//         /* empty */
//       }
