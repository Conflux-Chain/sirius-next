...
const enMerge = lodash.merge(en, ENV_CONFIG.ENV_LOCALES_EN);
const zhMerge = lodash.merge(zh_cn, ENV_CONFIG.ENV_LOCALES_CN);
...
export type TranslationResource = typeof enMerge;
