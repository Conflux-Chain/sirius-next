...
import { optsOrigin, previewOpts, defaultLimit, defaultIntervalType } from './config';
export function PreviewChartTemplate({ options, request }) {
    ...
    return _jsxs("div", { className: "bg-[#FFFFFF] border border-[#E5E5E5] rounded-lg shadow-sm", children: [_jsx(PreviewTitle, { header: opts.header }), _jsx("div", { className: 'p-[1.2857rem]', children: _jsx(HighchartsReact, { constructorType: 'stockChart', highcharts: Highcharts, options: opts, ref: chart }) })] });
}
