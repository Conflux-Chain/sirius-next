...
const ChartOptions = ({ intervalScope, intervalType, limit, onCombination }) => {
    ...
    return (_jsxs("div", { className: "flex relative z-2 top-[10px] mb-[20px] left-[40px]", children: [_jsxs("div", { className: 'flex gap-[3px] mr-[20px]', children: [_jsxs("div", { children: [t(translations.highcharts.options.time), ":"] }), Object.keys(intervalScopeDefault).map((e, i) => {
